...
export const FEATURE_LABELS: Record<FeatureKey, { title: string; description: string }> = {
  ...
  scenario_compare: { title: "Scenario Compare", description: "Side-by-side comparison of saved DCA scenarios to find the best strategy" },
  optimizer: { title: "Capital Allocation Optimizer", description: "AI-powered budget allocation across your portfolio for maximum cost-basis improvement" },
